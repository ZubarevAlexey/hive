...
class $$EmployeeTableFilterComposer
    extends FilterComposer<_$AppDb, $EmployeeTable> {
  $$EmployeeTableFilterComposer(super.$state);
...
class $$EmployeeTableOrderingComposer
    extends OrderingComposer<_$AppDb, $EmployeeTable> {
  $$EmployeeTableOrderingComposer(super.$state);
...
class $$EmployeeTableTableManager extends RootTableManager<
  ...
  $$EmployeeTableTableManager(_$AppDb db, $EmployeeTable table)
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$EmployeeTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$EmployeeTableOrderingComposer(ComposerState(db, table)),
